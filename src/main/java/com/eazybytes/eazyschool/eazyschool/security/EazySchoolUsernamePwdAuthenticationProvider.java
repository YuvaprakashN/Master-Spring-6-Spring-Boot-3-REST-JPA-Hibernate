package com.eazybytes.eazyschool.eazyschool.security;
...
public class EazySchoolUsernamePwdAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (person.getPwd().equals(password)){
           return new UsernamePasswordAuthenticationToken(person.getEmail(),password,grantedAuthorities(person.getRoles()));
        }else {
